...
import { 
    X, Clock, Lightbulb, Instagram, Navigation, Ticket, Headphones, 
    Play, Pause 
} from 'lucide-react';
import { Activity } from '../types';
import { BUS_AUDIO_GUIDE, ALNES_AUDIO_GUIDE, AKSLA_AUDIO_GUIDE, ART_NOUVEAU_AUDIO_GUIDE } from '../constants';
...
const ActivityDetailModal: React.FC<ActivityDetailModalProps> = ({ activity, onClose, initialAutoOpen = false }) => {
    ...
    const toggleTrack = (track: { id: string, text: string }) => {
    ...
    let audioData: { id: string, title: string, text: string }[] | null = null;
    let audioTitle = "";
    ...
    if (activity.id === '5') {
        ...
        audioData = BUS_AUDIO_GUIDE;
        audioTitle = "Audioguía: El Camino a Godøya";
    } else if (activity.id === '8') {
        audioData = AKSLA_AUDIO_GUIDE;
        audioTitle = "Audioguía: Aksla – La Atalaya";
    } else if (activity.id === '9') {
        audioData = ART_NOUVEAU_AUDIO_GUIDE;
        audioTitle = "Audioguía: Corazón Art Nouveau";
    }
